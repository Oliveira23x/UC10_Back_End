    ...
    public class ContaReceberService : IContaReceberService
    {
        ...
        public async Task<ContaReceberDto?> ObterPorIdAsync(int id)
        {
            var conta = await _context.ContasReceber
                .Include(c => c.Cliente)// serve para carregar os dados do cliente relacionado à conta a receber, permitindo que as informações do cliente sejam acessíveis ao criar o DTO de ContaReceberDto.
                .AsNoTracking() //
